...
class CategoryController extends Controller
{
        ...
        if($request->ajax()) {
            ...
            return Datatables::of($categories)
                ...
                ->addColumn('models',function ($categories){
                    ...
                    return '
                    <a href="'.$url.'" class="btn btn-md btn-default">عرض الموديلات <i class="fa fa-eye"></i> </a>
                    ';
                })
                ->escapeColumns([])
                ->make(true);
    ...
    public function store(request $request): \Illuminate\Http\JsonResponse
    {
        $inputs = $request->validate([
            ...
            'unique'     => 'تم تسجيل الماركة من قبل'
        ]);
    ...
    public function update(Request $request)
    {
        $inputs = $request->validate([
            ...
            'title.unique'     => 'تم تسجيل الماركة من قبل'
        ]);
            ...
            return Datatables::of($models)
                ->addColumn('action', function ($models) {
                    return '
                            ...
                            <button class="btn btn-pill btn-danger-light" data-toggle="modal" data-target="#delete_modal"
                                    data-id="' . $models->id . '" data-title="' . $models->title . '">
                                    <i class="fas fa-trash"></i>
                            </button>
                       ';
                })
