...
@section('title')  {{($setting->title) ?? ''}} | ماركات @endsection
@section('page_name') ماركات السيارات @endsection
@section('content')
    <div class="row">
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-gray mt-2">ماركات وموديلات السيارات</p>
                    <div class="">
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-striped table-bordered w-100" id="dataTable">
                            ...
                            <tr class="fw-bolder text-muted bg-light">
                                ...
                                <th class="min-w-20px">الموديلات</th>
        ...
        <div class="modal fade" id="editOrCreate" data-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="example-Modal3">ماركة سيارة</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
