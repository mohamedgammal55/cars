...
@section('title')  {{($setting->title) ?? ''}} | المدن @endsection
@section('page_name') قائمة المدن @endsection
@section('content')
    <div class="row">
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-gray mt-2">قائمة بالمدن والبلديات في قطر</p>
                    <div class="">
...
@section('ajaxCalls')
    <script>
        ...
        // Delete Using Ajax
        deleteScript('{{route('city.delete')}}');
        // Add Using Ajax
