...
@section('title')  {{($setting->title) ?? ''}} | السيارات @endsection
@section('page_name')  السيارات @endsection
        ...
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-gray mt-2">السيارات</p>
                    <div class="">
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-striped table-bordered w-100" id="dataTable">
                            ...
                            <tr class="fw-bolder text-muted bg-light">
                                ...
                                <th class="min-w-20px">الماركة</th>
                                <th class="min-w-20px">الموديل</th>
